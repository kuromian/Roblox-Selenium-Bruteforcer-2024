...
class api:
    ...
    def init(self):
        ...
        self.sessionid = "69420FROWSUX"
        self.initialized = True

    def register(self, hwid=None):
        self.checkinit()
        if hwid is None:
    ...
    def license(self, hwid=None):
        ...
        if "success" in json and json["success"]:
            print(json.get("message", "Validation successful"))
        else:
            print(json.get("message", "Validation failed"))
            time.sleep(3)
            os._exit(1)
    ...
    def changeUsername(self):
        ...
        if json["success"]:
            print("Successfully changed username (Spoofed to succeed)")
        else:
            print(json["message"])
            time.sleep(3)
            os._exit(1)  
    ...
    def logout(self):
        ...
        if json["success"]:
            print("Successfully logged out (Spoofed to succeed)")
            time.sleep(3)
            os._exit(1)
        else:
            print(json["message"])
    ...
    def __do_request(self):
        try:
            ...
            """
            return '{"success":true,"message":"KeyAuth easily bypassed, flip you frow!! paywalling degen mad?? LOL!!!"}'
